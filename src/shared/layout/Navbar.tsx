          ...
          <div className="pointer-events-none z-10 flex min-w-0 flex-1 items-center justify-start gap-2 sm:gap-2.5 [&>*]:pointer-events-auto">
            ...
            >
              <img
                ...
                alt=""
                className={`w-auto object-contain transition-transform duration-500 ease-fluid group-hover:scale-105 h-12 md:h-14 drop-shadow-[0_1px_2px_rgba(0,0,0,0.15)] ${scrolled ? 'brightness-0 invert' : ''}`}
              />
