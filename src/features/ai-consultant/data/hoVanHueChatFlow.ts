...
export const chatSteps: Record<string, ChatStep> = {
  welcome: {
    message: 'Xin chào! Mình là AI Consultant cho tuyến cưới Hồ Văn Huê. Mình sẽ hỏi nhanh về ngân sách, phong cách và ưu tiên rồi ghim các vendor phù hợp lên bản đồ.\n\nBạn muốn bắt đầu không?',
    quickReplies: [
