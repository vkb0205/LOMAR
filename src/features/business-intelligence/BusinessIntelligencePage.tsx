...
export default function BusinessIntelligence() {
  ...
  return <div className="min-h-[70vh] bg-[#f7f8fa] px-4 pb-8 pt-24 text-slate-900 sm:px-8 sm:pt-28 lg:px-12"><div className="mx-auto max-w-[1440px]">
    ...
    <div className="mt-5 grid gap-5 xl:grid-cols-[1.5fr_1fr]"><section className="rounded-2xl border border-slate-200 bg-white p-5"><h2 className="font-bold">Revenue overview</h2><p className="mt-1 text-xs text-slate-500">Gross merchandise value over time</p><div className="mt-4"><RevenueChart /></div></section><section className="rounded-2xl border border-slate-200 bg-white p-5"><h2 className="font-bold">Top categories</h2><p className="mt-1 text-xs text-slate-500">Revenue contribution</p><div className="mt-4"><CategoryPieChart /></div></section></div>
