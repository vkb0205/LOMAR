          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                'Sản phẩm thiết kế độc bản',
                'Ưu đãi voucher lên đến 20%',
              ...
              {products.map((product, index) => (
                ...
                >
                  <div className="w-full aspect-[3/4] relative overflow-hidden bg-gray-50">
                    <img 
                      src={product.image_url || 'https://images.unsplash.com/photo-1595000072051-5afcb1eef556?auto=format&fit=crop&q=80&w=600'} 
        ...
        <div className="bg-[#1B2C40] rounded-[40px] p-8 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/70 max-w-2xl mx-auto mb-10 text-sm md:text-base">
              Hãy để Bé Song Hỷ đồng hành cùng bạn tạo nên những dấu ấn độc bản cho ngày cưới. Sử dụng công cụ thiết kế của chúng tôi để hiện thực hóa ý tưởng của bạn.
            </p>
            <Link 
              to="/customize" 
