...
- Database / Supabase — ../../../supabase/legacy/migrate_to_v2.sql is replay-safe with full RLS (Section 6b); frontend DB writes are typed with no as any.
